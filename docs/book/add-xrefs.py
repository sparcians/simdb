...
def linkify_compounds(text: str) -> str:
    ...
    replacements = [
        ...
        (r"Parts II and III", f"Parts {xref('part-ii','Part II')} and {xref('part-iii','Part III')}"),
        (r"Parts VIII and IX", f"Parts {xref('part-viii','Part VIII')} and {xref('part-ix','Part IX')}"),
